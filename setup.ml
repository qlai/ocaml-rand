...
(* OASIS_START *)
(* DO NOT EDIT (digest: e76205638df4489d2df48252bcd34581) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "base64.ml"});
               Executable
                 ({
                     cs_name = "aes";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "aes.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\215E|4\242\143\210=\167K\007\165\017\254}\194";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
