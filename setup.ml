...
(* OASIS_START *)
(* DO NOT EDIT (digest: c4044c7cceb25e950bc4ecc980b8d52b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description = Some [OASISText.Para "see synopsis."];
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "rand.ml"});
               Executable
                 ({
                     cs_name = "dgst";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "dgst.ml"});
               Executable
                 ({
                     cs_name = "ciphers";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "ciphers.ml"});
               Executable
                 ({
                     cs_name = "base64";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "base64enc.ml"});
               Executable
                 ({
                     cs_name = "aescbc";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "aes_cbc.ml"});
               Executable
                 ({
                     cs_name = "aesecb";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "aes_ecb.ml"});
               Executable
                 ({
                     cs_name = "aesccm";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "aes_ccm.ml"});
               Executable
                 ({
                     cs_name = "aesgcm";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "aes_gcm.ml"});
               Executable
                 ({
                     cs_name = "aesctr";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "aes_ctr.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "SA\158E\253\186\2222\b2\171647)\148";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
